var App = function () {
	...
	//////////////////////////////
	// Handle sidebar menu
    var handleNavDropdown = function () {
        
        // handle ajax links
        jQuery('.navbar-menu').on('click', ' li > a.ajaxify', function (e) {
            e.preventDefault();
            App.scrollTop();

            var url = $(this).attr("href");
            //var menuContainer = "index1.html"; 
		    var menuContainer = jQuery('.navbar-menu ul');
            //var pageContent = $('.page-content');
            var pageContentBody = $('.page-container');
    ...
    return {
        init: function () {
			...
			handleFixedHeader();
			handleNavDropdown();
			$('.navbar-menu .ajaxify start').click();
        },
